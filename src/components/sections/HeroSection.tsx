    ...
    <section className="relative min-h-screen flex flex-col justify-end pb-20 md:pb-32 overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="max-w-4xl">
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-[8rem] font-bold text-white tracking-tighter leading-[0.9] mb-5 md:mb-8">
            Kompromisslos. <br /> <GradientText>Sauber.</GradientText>
          </h1>
          <p className="text-lg sm:text-xl md:text-3xl text-zinc-400 max-w-2xl font-light leading-relaxed mb-8 md:mb-12">
